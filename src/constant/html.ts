...
const htmlRegister = (OTPCode: string) => {
  return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
      ...
      <body>
          <p>Xin chào,</p>
          <p>Bạn đang đăng nhập vào hệ thống Smember của <strong>${SUBJECT}</strong>. Sử dụng mã OTP bên dưới để hoàn tất quá trình đăng kí. Mã OTP chỉ có hiệu lực trong 2 phút.</p>
          <p><strong style="font-size: 24px;">${OTPCode}</strong></p>
          <p>Mọi thắc mắc, Quý khách vui lòng liên hệ tổng đài hỗ trợ <strong>0345.299.087</strong> từ 8:00 - 22:00.</p>
          <p>Trân trọng,</p>
          <p>${SUBJECT}</p>
...
export { htmlResetPassword, htmlRegister };
